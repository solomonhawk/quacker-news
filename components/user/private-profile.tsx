          ...
          <tr className="align-top">
            ...
            <td>
              <Link href={`/submitted?id=${user.username}`}>
                <a className="block underline opacity-60 hover:opacity-100">submissions</a>
              </Link>

              <Link href={`/threads?id=${user.username}`}>
                <a className="block underline opacity-60 hover:opacity-100">comments</a>
              </Link>

              <Link href="/hidden">
                <a className="block underline opacity-60 hover:opacity-100">hidden</a>
              </Link>

              <Link href={`/favorites?id=${user.username}`}>
                <a className="block underline opacity-60 hover:opacity-100">favorites</a>
              </Link>
            </td>
          </tr>
        </tbody>
