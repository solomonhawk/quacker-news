...
const AskPage: NextPage<InferGetServerSidePropsType<typeof getServerSideProps>> = ({ page }) => {
  const postsQuery = trpc.useQuery(['post.all', { page, type: PostType.ASK }]);

  return (
    <>
      <Head>
        <title>QuackerNews - Ask QN</title>
...
export const getServerSideProps: GetServerSideProps = async ctx => {
  ...
  return dehydrateQueries(ctx, async ssg => await ssg.fetchQuery('post.all', { page, type: PostType.ASK }), { page });
};
